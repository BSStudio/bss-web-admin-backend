...
internal class EventControllerTest(
    ...
    private companion object {
        ...
        private val EVENT = Event(id = EVENT_ID, url = URL, title = TITLE, description = DESCRIPTION, dateFrom = DATE, visible = VISIBLE)
        ...
        private val UPDATE_EVENT = UpdateEvent(url = URL, title = TITLE, description = DESCRIPTION, dateFrom = DATE, visible = VISIBLE)
