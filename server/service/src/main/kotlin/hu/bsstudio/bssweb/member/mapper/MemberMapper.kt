...
class MemberMapper {
    fun entityToModel(entity: DetailedMemberEntity) =
        Member(
            id = entity.id,
            url = entity.url,
            name = entity.name,
    ...
    fun entityToModel(entity: SimpleMemberEntity) =
        SimpleMember(
            id = entity.id,
            name = entity.name,
            nickname = entity.nickname,
    ...
    fun modelToEntity(model: CreateMember) =
    ...
    fun updateToEntity(
        memberEntity: DetailedMemberEntity,
