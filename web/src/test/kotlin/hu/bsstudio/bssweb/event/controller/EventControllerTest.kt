...
internal class EventControllerTest {
    ...
    internal fun findEventById1() {
        every { mockService.findEventById(EVENT_ID) } returns Optional.of(EVENT_1)
    ...
    internal fun updateEvent1() {
        every { mockService.updateEvent(EVENT_ID, UPDATE_EVENT) } returns Optional.of(EVENT_1)
    ...
    private companion object {
        private const val EVENT_ID: String = "id"
        private val EVENT_1: Event = Event(EVENT_ID, "name", "description", LocalDate.of(2022, 1, 1), false)
        private val CREATE_EVENT: CreateEvent = CreateEvent(EVENT_ID, "name")
        private val UPDATE_EVENT: UpdateEvent = UpdateEvent("name", "description", LocalDate.of(2022, 1, 1), false)
        private val EVENT_LIST: List<Event> = listOf(EVENT_1)
    }
}
